...
const classOneRoutes = model.subCategoryOne;
...
const createClassOne  = async (req, res) => {
    ...
    await classOneRoutes.findOrCreate({
        where: {
...
const updateClassOne = async (req, res) => {
    ...
    await classOneRoutes.update(req.body,
        {
        where: {
            catOneName: id
        }
